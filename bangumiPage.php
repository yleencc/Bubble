        ...
        <main>
                        ...
                        <div class="container shape-container d-flex align-items-center py-lg">
                                <div class="col px-0 text-center">
                                        ...
                                        <h5 class="text-white" style="display: block;">
                                                <?php echo ViewsCounter_Plugin::getViews(); ?> 浏览
					</h5>
                                </div>
                        </div>
                </section>
                <section class="section section-components bg-secondary content-card-container">
                        <div class="container container-lg py-5 align-items-center content-card-container">
							...
							<?php $this->content(); ?>
							<div>
								<h3 style="font-weight: 500; border-bottom: 4px solid lightpink; margin-bottom: 1rem">在看</h3>
								<div data-type="watching" class="bgm-collection"></div>
							</div>
							<div> 
								<h3 style="font-weight: 500; border-bottom: 4px solid lightpink; margin-bottom: 1rem">已看</h3>
								<div data-type="watched" data-cate="anime" class="bgm-collection"></div> </div>
                                                        </div>
                                                </div>
                                        </section>
                                </div>
